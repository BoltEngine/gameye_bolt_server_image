...
ENV GE_DEFAULTGAMEARGS -batchmode -nographics -logFile
...
# Setup executable
ENTRYPOINT exec ${GE_ENTRYPOINTSCRIPT} ${GE_DIRCONFIG}/${GE_CONFIGFILE} ${GE_DIRGAME}/${GE_GAMEBIN} ${GE_DEFAULTGAMEARGS}